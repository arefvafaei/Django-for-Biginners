...
class BlogTest(TestCase):
    ...
    def test_post_create_view(self):
        ...
        self.assertEqual(Post.object.last().title, 320)
        self.assertEqual(Post.object.last().body, 320)
    def test_post_update_view(self):
        ...
        self.assertEqual(Post.object.last().title, ("Update title"))
        self.assertEqual(Post.object.last().body, ("Update text"))
